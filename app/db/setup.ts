...
async function main() {
  ...
  await conn.execute(`
    CREATE TABLE eventos (
      id bigint unsigned auto_increment PRIMARY KEY,
      tipo enum('LEAD_CREADO', 'LEAD_ASIGNADO', 'ESTADO_CAMBIADO', 'SEGUIMIENTO_ENVIADO', 'RESPUESTA_RECIBIDA', 'OBJECION_REGISTRADA', 'LEAD_DESCARTADO', 'NOTA_AGREGADA', 'LLAMADA_REGISTRADA', 'PAGO_REGISTRADO', 'CALENDAR_EVENTO_CREADO', 'CALENDAR_EVENTO_ACTUALIZADO', 'CALENDAR_EVENTO_SINCRONIZADO') NOT NULL,
